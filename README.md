...
```
npm install @chainvue/sdk@v0.1.0-test6 --save
```
...
*CurrenciesApi* | [**getCurrency**](docs/CurrenciesApi.md#getcurrency) | **GET** /v1/currencies/{currency_id} | 
*CurrenciesApi* | [**listCurrencies**](docs/CurrenciesApi.md#listcurrencies) | **GET** /v1/currencies | 
